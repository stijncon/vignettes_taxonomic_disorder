...
## Introduction
This repo contains all the code for the analysis of the data presented in the paper 'Taxonomic disagreement about ranks in gray-area taxa: A vignette study', published [here](https://academic.oup.com/bioscience/article/73/10/728/7284739) in Bioscience. 

**Note: The main purpose of this repository is transparency and replicability. The code is not intended for reuse beyond rerunning the analyses from the paper with the publicly available data.**

## Research summary

This paper used vignettes to investigate what factors might drive disagreements about species delimitation in gray-area taxa. Most notably, we looked at the role of species concepts, conservation values and evidence-types.
...
Notebooks may require Jupyter to run.

## License
See the LICENSE file for usage terms.

## Citation
If referencing this project, please cite the corresponding paper (if any) or contact the author.

---

Repository maintained by Stijn Conix. For academic transparency only.
